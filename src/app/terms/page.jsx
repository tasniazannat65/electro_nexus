    ...
    <div className="min-h-screen bg-base-100 py-10">
      <div className="max-w-7xl mx-auto p-8 bg-base-200 rounded-xl shadow-xl border border-base-300">
        ...
        <p className="text-sm text-neutral/80 mb-4">
          Welcome to ElectroNexus. These Terms and Conditions govern your use of
          our website. By accessing or using ElectroNexus, you agree to be bound
          by these terms.
        </p>
        ...
        <div className="space-y-4 text-sm">
          <div>
            ...
            <p>
              ...
              to use the site only for lawful purposes and in a way that does
          ...
          <div>
            ...
            <p>
              ...
              details and for all activities that occur under your account.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              without notice. We try to ensure accuracy, but we do not guarantee
              it.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              the property of ElectroNexus or its partners. You may not copy or
          ...
          <div>
            ...
            <p>
              ElectroNexus is not liable for any direct or indirect damages
              resulting from the use of the website. Use the site at your own
              risk.
            </p>
          </div>
