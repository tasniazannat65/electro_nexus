      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-5 text-base md:text-lg text-neutral/70 max-w-2xl mx-auto">
            Simple and fast process to get your favorite electronics at your
            doorstep.
          </p>
        </div>
              ...
              <div key={index} className="relative group">
                <div className="relative bg-base-100 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-base-300/50 overflow-hidden">
                  ...
                  <div className="absolute -top-4 -right-4 w-24 h-24 opacity-5">
                    <div
                      className={`text-8xl font-black bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent`}
                    >
                      {step.number}
                    </div>
                  </div>
                  ...
                  <div className="relative mb-6">
                    <div
                      className={`inline-flex items-center justify-center w-20 h-20 rounded-xl bg-gradient-to-br ${step.gradient} p-0.5 group-hover:scale-110 transition-transform duration-300 `}
                    >
                    ...
                    <div
                      className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-br ${step.gradient} flex items-center justify-center text-white text-sm font-bold shadow-lg`}
                    >
                      {index + 1}
                    </div>
                  </div>
