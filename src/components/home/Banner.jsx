...
const Banner = () => {
    ...
    <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <pattern id="circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            ...
            <line x1="20" y1="20" x2="80" y2="20" stroke="currentColor" strokeWidth="0.5" className="text-primary"/>
            <line x1="80" y1="20" x2="80" y2="80" stroke="currentColor" strokeWidth="0.5" className="text-accent"/>
          </pattern>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
              ...
              Premium Electronics
                    ...
                    <h1 className='text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight'>
                        Elevate Your Tech <br /> <span className='bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-gradient'>Experience</span>

                    </h1>

                    <p className='text-base md:text-lg text-neutral/80 max-w-xl leading-relaxed'>
                         Discover cutting-edge electronic devices engineered for peak performance, 
              seamless connectivity, and unmatched reliability. Transform the way you work, 
              play, and connect. 
                    </p>
                ...
                <div className='relative animate-fade-zoom'>
                    ...
                    <div className='relative'>
                        <div className='absolute -inset-8 bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 rounded-full blur-3xl animate-pulse-slow'>

                        </div>
                        <div className='relative rounded-xl overflow-hidden shadow-2xl border-4 border-base-100'>
                            <Image src="https://images.unsplash.com/photo-1605360846332-1378e0c96955?q=80&w=704&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
