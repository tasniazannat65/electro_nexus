        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Ready to Explore the <br className="hidden md:block" />{" "}
              <span className="text-accent-content">Best Electronics?</span>
            </h2>
        ...
        <div className="mt-10 pt-8 border-t border-white/20">
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 md:gap-12 text-white">
            <div className="text-center lg:text-left">
              <div className="text-3xl md:text-4xl font-bold text-accent-content">
                10K+
              </div>
